  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-[24px] border p-5" style={{ borderColor: "var(--border)", background: "var(--panel)" }}>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          <UploadField label="Laptop Front" onChange={setLaptopFrontFile} preview={getImageUrl(selectedAsset.laptop_front_image)} />
          <UploadField label="Laptop Rear" onChange={setLaptopRearFile} preview={getImageUrl(selectedAsset.laptop_rear_image)} />
          <UploadField label="Mouse" onChange={setMouseFile} preview={getImageUrl(selectedAsset.mouse_image)} />
          <UploadField label="Charger" onChange={setChargerFile} preview={getImageUrl(selectedAsset.charger_image)} />
        </div>
        <button
          type="button"
      ...
      <section className="rounded-[24px] border p-5" style={{ borderColor: "var(--border)", background: "var(--panel)" }}>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          <ServiceStat label="Service Status" value={selectedAsset.service_status ?? "In Use"} />
