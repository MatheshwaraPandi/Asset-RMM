...
export default function SidebarNavigation({ userRole, userName }: SidebarNavigationProps) {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      submenu: isAdmin ? [
        {
          label: "Asset Management Dashboard",
          href: "/admin",
          description: "Operations console",
        },
        {
          label: "Device Inventory Dashboard",
          href: "/device-dashboard",
          description: "Device inventory",
        },
        {
          label: "Service Tracking Dashboard",
          href: "/tracking",
                ...
                return (
                  <div key={index}>
                    <button
                      ...
                      className="w-full flex items-center justify-between gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-300 hover:bg-white/10 hover:text-white transition-colors"
                    >
                      ...
                      <div className="ml-4 mt-2 space-y-1 border-l border-white/10 pl-4">
                        {item.submenu.map((subitem, subindex) => (
                          ...
                          >
                            ...
                            <div className="text-slate-500 text-[10px] mt-0.5">{subitem.description}</div>
                          </Link>
                        ))}
                      </div>
                    )}
